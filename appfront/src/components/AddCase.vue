      ...
      <el-container>
        ...
        <el-main>
          <el-form>
            ...
            <el-input name="case_name" v-model="case_name" style="width: 300px;"></el-input>
            <br>
            ...
            <el-input name="request_data" v-model="request_data" style="width: 300px"></el-input>
            <br>
            ...
            <el-input name="case_bz" v-model="case_bz" type="textarea" style="width:300px;"></el-input>
            <br>
            <br>

            <el-button value="保存" @click="addcase" style="margin-left: 520px">保存</el-button>
  ...
  export default {
    ...
    methods: {
      addcase: function () {
        ...
        this.$axios.post('http://127.0.0.1:8000/add_cases/', {
          project_name: this.project_name,
          url: this.url,
          case_bz: this.case_bz,
          case_name: this.case_name,
          request_data: this.request_data,
          request_type: this.selected
